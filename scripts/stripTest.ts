...
function makeScene() {
  ...
  geo.setAttribute(
    "position",
    new THREE.BufferAttribute(new Float32Array([0, 1, 0, 0, 1.5, 0, 0, 1.7, 0]), 3),
  );
  geo.setAttribute(
    "normal",
  ...
  geo.setAttribute(
    "skinIndex",
    new THREE.BufferAttribute(new Uint16Array([0, 0, 0, 0, 1, 0, 0, 0, 2, 0, 0, 0]), 4),
  );
  geo.setAttribute(
    "skinWeight",
    new THREE.BufferAttribute(new Float32Array([1, 0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0]), 4),
  );
  geo.setIndex([0, 1, 2]);
